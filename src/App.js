  ...
  const PG_COURSE = [
    {
      ...
      features: ['Caltech CTME Post Graduate Certificate', 'Enrolment in Simplilearn’s JobAssist', 'Receive upto 30 CEUs from Caltech CTME', 'Get noticed by the top hiring companies']
    },
    {
      title: "Post Graduate Program in Data Science",
      time: "10Months",
      src: "https://www.simplilearn.com/ice9/assets/pdp-slider_1.jpg",
      features: ['Purdue Post Graduation Program certification ', 'Exclusive Ask me Anything sessions by IBM', 'Capstone from 3 domains ']
    },
    {
